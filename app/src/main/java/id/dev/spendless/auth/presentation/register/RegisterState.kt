...
data class RegisterState(
    ...
    val formattedTotalSpend: String = totalSpend.formatTotalSpend(ExpensesFormatEnum.MinusPrefix, CurrencyEnum.IDR, DecimalSeparatorEnum.Comma, ThousandsSeparatorEnum.Dot),
